...
const UIProvider = ({ children })=>{
    ...
    const [confirmConfig, setConfirmConfig] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
                ...
                "UIProvider.useCallback[showToast]": ()=>{
                    setToasts({
                        "UIProvider.useCallback[showToast]": (prev)=>prev.filter({
                                "UIProvider.useCallback[showToast]": (t)=>t.id !== id
                            }["UIProvider.useCallback[showToast]"])
                    }["UIProvider.useCallback[showToast]"]);
                }
    ...
    const confirmAction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "UIProvider.useCallback[confirmAction]": (title, message)=>{
            return new Promise({
                "UIProvider.useCallback[confirmAction]": (resolve)=>{
                    setConfirmConfig({
                        title,
                        message,
                        onConfirm: {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UIContext.Provider, {
        ...
        children: [
                ...
                children: toasts.map((toast)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    toast.type === 'success' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    ...
                                    toast.type === 'error' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "toast-icon",
                                        children: "⚠️"
                                    }, void 0, false, {
                                        fileName: "[project]/src/context/UIContext.jsx",
                                    ...
                                    toast.type === 'info' && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        className: "toast-icon",
                                        children: "ℹ️"
                                    }, void 0, false, {
                                        fileName: "[project]/src/context/UIContext.jsx",
            ...
            confirmConfig && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(UIProvider, "rPVESNKVL1nwZK8+/q63QdXgtIc=");
_c = UIProvider;
const useUI = ()=>{
    _s1();
...
const Inventory = ()=>{
   ...
   */ const handleOpenAddModal = ()=>{
    ...
    const handleSaveItemEdit = async ()=>{
        ...
        // Show confirmation dialog using global UIContext
        const confirmed = await confirmAction('Confirm Save', `Are you sure you want to save changes to ${editFormData.name}?`);
        if (confirmed) {
            try {
   ...
   */ const handleSaveTransaction = async ()=>{
        ...
        if (showTransactionModal.isEdit && showTransactionModal.index !== null) {
            const confirmed = await confirmAction('Confirm Save', 'Are you sure you want to save changes to this transaction?');
            if (confirmed) {
                try {
   ...
   */ const handleSaveRestock = async ()=>{
        ...
        showConfirmation('Confirm Restock', `Are you sure you want to restock this item with ${qty} units?`, async ()=>{
            try {
                ...
                showToast('Failed to restock: ' + e.message, 'error');
            } finally{
   ...
   */ const handleDeleteTransaction = async (index)=>{
        if (!showMoreInfo) return;
        const confirmed = await confirmAction('Confirm Deletion', 'Are you sure you want to delete this transaction?');
        if (confirmed) {
            try {
...
_s(Inventory, "0dEL7c7aufnHC2xHCVWdlilx3jc=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UserRoleContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUserRole"],
...
const Users = ()=>{
    ...
    const handleAddSubmit = async (e)=>{
        ...
        try {
            ...
            showToast('User added successfully! Password securely encrypted.', 'success');
            setShowAddModal(false);
            setFormData({
                name: '',
                email: '',
    ...
    const handleDeleteUser = async (user)=>{
        const confirmed = await confirmAction('Confirm Deletion', `Are you sure you want to completely remove ${user.name}?`);
        if (confirmed) {
            try {
...
_s(Users, "LkLzcKqK/nzLScEUo/y82zBuptk=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$UIContext$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useUI"]
    ];
});
...
//# sourceMappingURL=src_1o7rnm5._.js.map